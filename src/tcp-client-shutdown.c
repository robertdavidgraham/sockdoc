/* tcp-client-shutdown
 Demonstrates using shutdown() to close one end of the socket
 Example usage:
    tcp-client-shutdown www.google.com 80
 This will send an HTTP request immediately followed by a FIN packet.
 */
#include <ctype.h>
#include <errno.h>
#include <signal.h>
...
static const char *my_http_request =
    "GET / HTTP/1.0\r\n"
    "User-Agent: tcp_client-shutdown/0.0\r\n"
    "\r\n";
...
int main(int argc, char *argv[])
{
    ...
    if (argc != 3) {
        fprintf(stderr, "[-] usage: tcp-client-shutdown <host> <port>\n");
        return -1;
    }
